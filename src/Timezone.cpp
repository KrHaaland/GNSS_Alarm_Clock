...
static const TzBox kZones[] = {
    ...
    {9.5f, 28.6f, 92.2f, 101.2f, "Asia/Yangon", "<+0630>-6:30"},
    ...
    {21.7f, 31.9f, 24.6f, 37.0f, "Africa/Cairo", "EET-2EEST,M4.5.5/0,M10.5.4/24"},
    ...
    {29.5f, 38.5f, 60.5f, 71.2f, "Asia/Kabul", "<+0430>-4:30"},
    {23.5f, 37.1f, 61.0f, 77.8f, "Asia/Karachi", "PKT-5"},
};
