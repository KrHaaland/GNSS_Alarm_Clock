...
_Last updated: 2026-09-06 — **release [v1.0.1](https://github.com/KrHaaland/GNSS_Alarm_Clock/releases/tag/v1.0.1)** (bin + UF2 for both boards); previously [v1.0.0](https://github.com/KrHaaland/GNSS_Alarm_Clock/releases/tag/v1.0.0) published** (bin + UF2 for both boards)_
