...
//  PA16       | OLED_RST    | D13     | display reset (active low)
//  PA17       | OLED_DC     | D12     | display data/command
//  PA18       | OLED_CS     | D10     | display chip select (active low)
...
// --- Display (NV3007 428x142 landscape RGB565 TFT, 4-wire SPI on J3) ---
